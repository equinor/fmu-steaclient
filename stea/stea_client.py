...
class SteaClient(object):
    ...
    def get_project(self, project_id, project_version , config_date):
        ...
        try:
            ...
            raise RuntimeError("HTTP GET form {url} failed: {error}]".format(url=url, error=str(e)))
    ...
    def calculate(self, request):
        ...
        try:
            ...
            raise RuntimeError("HTTP POST to {url} failed: {error}]".format(url=url, error=str(e)))
